        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    ...
                    <a href="/sales/<?= $sale['id'] ?>/print" class="btn btn-outline-secondary me-2" target="_blank">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="3" class="text-end">Impuesto (<?= number_format(($sale['tax'] / $sale['subtotal']) * 100, 2) ?>%):</td>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <h6 class="card-subtitle mb-1 text-muted">Método de Pago</h6>
                                <p class="card-text">
                            ...
                            <?php if (!empty($sale['notes'])): ?>
                                <div class="mb-3">
                                    <h6 class="card-subtitle mb-1 text-muted">Notas</h6>
                                    <p class="card-text"><?= nl2br(htmlspecialchars($sale['notes'])) ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="/customers/<?= $sale['customer_id'] ?>" class="btn btn-sm btn-outline-primary">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0"><?= htmlspecialchars($sale['user_name'] ?? 'Usuario no disponible') ?></h6>
